...
```bash
sh -c "$(wget --no-check-certificate -qO - https://raw.githubusercontent.com/evgarthub/klipper_tmc_autotune_k1/main/install.sh)"
```
...
origin: https://github.com/evgarthub/klipper_tmc_autotune_k1.git
